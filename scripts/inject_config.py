...
cfg = json.load(open("config/config_v1.json"))
...
class CapitalAllocator:
    ...
    def decision_policy(self, score):
        if score < 0.55:
            ...
            return "AGGRESSIVE EXECUTE", {cfg["max_risk"]}
...
open("core/engines/allocator.py", "w").write(content)

print("✅ Config injected into allocator")